...
from wpt_tools.solvers import efficiency_calculator, compute_load_sweep
...
class TestEdgeCases:
    ...
    def test_efficiency_calculator_zero_efficiency(self):
        ...
        assert all(eff >= 0 for eff in results.eff_opt)  # Efficiency should be non-negative
    ...
    def test_rich_network_target_frequency_out_of_range(self):
        ...
        with pytest.raises(ValueError, match="Target frequency not found within specified range"):
